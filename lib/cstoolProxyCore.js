...
/**
 * CSTool exposes job status at /cstoolconvoai/ten_err_status/:jobId (see parse_ten_err
 * JSON status_url). Legacy poll-ten-err alias maps to the same upstream path.
 */
