...
/**
 * Public URL path under /cstoolconvoai/ uses poll-ten-err/:jobId so the edge proxy
 * does not use a fragile /api/cstool/api/... pattern. Maps to upstream
 * api/ten_err_status/:jobId. The Vercel handler lives at /api/cstoolconvoai/[...path].
 */
