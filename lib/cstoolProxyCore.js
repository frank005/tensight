...
/**
 * Public URL path under /cstoolconvoai/ uses poll-ten-err/:jobId so Vercel never
 * routes to /api/cstool/api/... (NOT_FOUND). Maps to upstream api/ten_err_status/:jobId.
 */
